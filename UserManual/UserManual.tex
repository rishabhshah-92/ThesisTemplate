...
Next, in the \verb|AllOtherCrap| folder, open the \verb|Thesis_Central.tex| file. Scroll down and find the chapter inclusion commands (\verb|\include{ch01/ch01}|). To include your new chapter, just enter another line: \verb|\include{ch03/ch03}|.
